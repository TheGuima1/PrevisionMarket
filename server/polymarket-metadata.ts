 ...
 * - 3% spread aplicado na execução (invisível ao usuário)
...
/**
 * Os mercados da Palpites.AI - Eleição Presidencial Brasil 2026
 * 9 candidatos espelhados do Polymarket
 * Slugs EXATOS do Polymarket (não simplificados)
 */
